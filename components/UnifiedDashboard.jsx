      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-4">
          ...
          <div className="space-y-3">
            {Array.from({ length: 3 }).map((_, i) => (
              <div key={i} className="flex items-center gap-3 rounded-xl border border-slate-200 p-3">
                ...
                <div className="h-6 w-12 rounded bg-gradient-to-br from-violet-500 to-cyan-400" />
                <div className="flex h-6 items-end gap-0.5">
                  {Array.from({ length: 8 }).map((__, j) => (
                    <div key={j} className="w-1.5 rounded-t bg-gradient-to-t from-violet-400 to-cyan-400" style={{ height: `${20 + j * 8}%` }} />
                  ))}
                </div>
              </div>
            ))}
        ...
        <div className="space-y-3">
          <div className="rounded-xl border border-slate-200 p-3">
            ...
            <div className="h-2 w-full rounded bg-gradient-to-r from-violet-400 to-cyan-400" />
