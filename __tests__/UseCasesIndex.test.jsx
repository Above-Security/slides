...
describe('UseCasesIndex Component', () => {
  ...
  describe('Analytics Integration', () => {
    it('initializes Clarity on component mount', () => {
      ...
      expect(mockClarityEvent).toHaveBeenCalledWith('use_cases_index_view')
      expect(mockClaritySet).toHaveBeenCalledWith('page_type', 'use_cases_index')
    })
    ...
    it('tracks use case clicks', async () => {
      ...
      expect(mockClarityEvent).toHaveBeenCalledWith('use_case_clicked', { 
        use_case: 'phishing-detection' 
      })
      expect(mockClaritySet).toHaveBeenCalledWith('selected_use_case', 'phishing-detection')
    })
    ...
    it('tracks logo clicks', async () => {
      ...
      expect(mockClarityEvent).toHaveBeenCalledWith('logo_clicked_from_use_cases')
    })
  })
  ...
  describe('Accessibility', () => {
    ...
    it('uses semantic HTML structure', () => {
      ...
      expect(screen.getByRole('main') || screen.getByRole('contentinfo')).toBeInTheDocument()
    })
  })
