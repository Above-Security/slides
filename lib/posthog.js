...
export const initPostHog = () => {
  if (typeof window !== 'undefined' && !posthog.__loaded) {
    ...
    window.__POSTHOG_DEPLOYMENT_VERSION = 'v2-fix-distinct-id-2025-01-13-0035';
    ...
    posthog.init(key, {
      ...
      // Skip the initial flags request that causes the distinct_id error
      loaded_before_featureflags: true,
      bootstrap: {
        featureFlags: {}
      },
      autocapture: true,
